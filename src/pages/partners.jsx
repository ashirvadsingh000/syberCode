  ...
  const services = [
    {
      icon: <LuBrain />,
      title: "David",
      description: "Basic Features based ideas for creating webpage",
    },
    {
      icon: <FaCode />,
      title: "Ashirvad Singh",
       ...
       <video
        ...
        <div className="container mx-auto px-4 z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-xl text-gray-300">Comprehensive cybersecurity education at your blueprint</p>
          </motion.div>
        </div>
      </section>
